...
export const updateRestaurantRequest = () => ({
  ...
  // --- Reviews ---
export const getRestaurantReviewsRequest = () => ({
  type: actionTypes.GET_RESTAURANT_REVIEWS_REQUEST,
});

export const getRestaurantReviewsSuccess = (reviews) => ({
  type: actionTypes.GET_RESTAURANT_REVIEWS_SUCCESS,
  payload: reviews,
});

export const getRestaurantReviewsFailure = (error) => ({
  type: actionTypes.GET_RESTAURANT_REVIEWS_FAILURE,
  payload: error,
});
